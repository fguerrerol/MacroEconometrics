...
my_data = ts(df, start = c(2001, 1) , end=c(2019,8), frequency = 12)
...
imacec_limpio <- ts(reg$residuals, start=c(2001,02),end=c(2019,8), frequency=12)
descarte <- ts(reg[["fitted.values"]], start=c(2001,02),end=c(2019,8), frequency=12)
...
# Para el documento 
descarte <- ts(reg2[["fitted.values"]], start=c(2001,02),end=c(2019,8), frequency=12)
...
VAR.GC.test.boot <- causality(VAR2, cause = c("ipc_sae",
                                              "tcn_var",
                                              "imacec_residuals",
                                              "ltpm_var",
                                              "embi_local_var")
...
VAR.GC.test.boot <- causality(VAR3, cause = c("ipc_sae",
                                              "tcn_var",
                                              "imacec_residuals",
                                              "ltpm_var",
                                              "embi_local_var")
